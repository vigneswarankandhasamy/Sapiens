                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                    <thead>
                                        <tr class="nk-tb-item nk-tb-head">
                                            <th class="nk-tb-col"><span class="sub-text">S.No</span>
                                            </th>
                                            <th class="nk-tb-col"><span class="sub-text">Invoice No</span>
                                            </th>
                                             <th class="nk-tb-col tb-col-md"><span class="sub-text">Order Date</span>
                                            </th>
...
<script type="text/javascript">
    ...
    $(".orderNotificationTD").click(function() { 
