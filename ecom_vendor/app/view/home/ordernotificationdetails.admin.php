                                        ...
                                        <table class="table table-bordered is-compact">
                                            ...
                                            <?php echo $data["order_items"]; ?>
                                                ...
                                                <?php 
                                                   $total         = $data['ven_order_info']['subTotal'] + $data['ven_order_info']['IGST_AMT'] - $data['order_discount_info']['couponValue']; 
                                                    $total_charges = $data['ven_order_info']['vendorCommissionAmt'] + $data['ven_order_info']['vendorPaymentChargeAmt'] + $data['ven_order_info']['vendorShippingChargeAmt'];
                                                    $total_without_discount = $data['ven_order_info']['subTotal']+ $data['ven_order_info']['shipping_cost'] + $data['ven_order_info']['IGST_AMT'] - $data['order_discount_info']['couponValue'];
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                if(data==1) {
                    ...
                    window.location = core_path+"orders/notificationdetail/"+vendor_order_id+"?or=success";
                } else {
                    window.location = core_path+"orders/notificationdetail/"+vendor_order_id+"?ore=success";
                }
