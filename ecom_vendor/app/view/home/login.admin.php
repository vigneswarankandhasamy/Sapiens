                    ...
                    <div class="nk-block nk-block-middle nk-auth-body  wide-xs">
                        <div class="brand-logo pb-4 text-center">
                            <a href="<?php echo COREPATH ?>" class="logo-link">
                                <img class="logo-light logo-img logo-img-lg logo-img-xl" src="<?php echo ASSETS_PATH ?>login_page_logo.png" srcset="<?php echo ASSETS_PATH ?>login_page_logo.png" alt="logo">
                                <img class="logo-dark logo-img logo-img-lg logo-img-xl" src="<?php echo ASSETS_PATH ?>login_page_logo.png" srcset="<?php echo ASSETS_PATH ?>login_page_logo.png" alt="logo-dark">
                            </a>
                        </div>
                        <div class="card">
