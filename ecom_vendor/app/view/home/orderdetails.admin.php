                                    ...
                                    <div class="nk-block-des">
                                        <nav>
                                           <ul class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li class="breadcrumb-item"><a href="<?php echo COREPATH ?>ordersettings">Orders</a></li>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <li class="nk-block-tools-opt"><a href="<?php echo COREPATH ?>orders/previewinvoice/<?php echo $data['order_info']['id'] ?>" class="btn btn-success" target="_blank"><em class="icon ni ni-file"></em><span>Order Invoice</span></a>
                                            </li>
                        ...
                        <div class="row gy-5">
                            ...
                            <?php 
                               $total         = $data['ven_order_info']['subTotal'] + $data['ven_order_info']['IGST_AMT'] - $data['order_discount_info']['couponValue']; 
                                ...
                                $total_with_discount = $data['ven_order_info']['subTotal'] + $data['ven_order_info']['IGST_AMT'] - $data['order_discount_info']['couponValue'];
                                    ...
                                    <ul class="data-list is-compact">
                                        <li class="data-item">
                                            <div class="data-col">
                                                ...
                                                <div class="data-value"><?php echo $data['order_item_tot']; ?></div>
                                            </div>
                                        </li>
                                        <li class="data-item">
                                            <div class="data-col">
                                    ...
                                    <ul class="data-list is-compact">
                                        ...
                                        <li class="data-item">
                                            <div class="data-col">
                                                ...
                                                <div class="data-value"><?php echo $data['ven_order_info']['vendor_invoice_number']; ?></div>
                                            </div>
                                        </li>
                                        <li class="data-item">
                                            <div class="data-col">
                                        ...
                                        <table class="table table-bordered is-compact">
                                            ...
                                            <?php echo $data["order_items"]; ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">₹ <?php echo number_format((($data['order_info']['coupon_value']!='') ? $data['order_discount_info']['couponValue'] : 0.00),2) ; ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" colspan="5">Shipping Amount :</td>
                                                    <td class="text-right">₹ <?php echo number_format($data['ven_order_info']['shipping_cost'],2)  ?></td>
                                                </tr>
                                                <?php 
                                                   $total         = $data['ven_order_info']['subTotal'] + $data['ven_order_info']['IGST_AMT'] - $data['order_discount_info']['couponValue']; 
                                                    $total_charges = $data['ven_order_info']['vendorCommissionAmt'] + $data['ven_order_info']['vendorPaymentChargeAmt'] + $data['ven_order_info']['vendorShippingChargeAmt'];
                                                    $total_with_discount = $data['ven_order_info']['subTotal'] + $data['ven_order_info']['IGST_AMT'] + $data['ven_order_info']['shipping_cost'] - $data['order_discount_info']['couponValue'];

                                                ?>
                                                <tr>
                                                    <td class="text-right" colspan="5">Total:</td>
                                                    <td class="text-right">₹ <?php echo number_format($total_with_discount,2)  ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">₹ <?php echo number_format($data['ven_order_info']['vendorPaymentChargeAmt'],2) ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" colspan="5">Shipping Charge:</td>
                                                    <td class="text-right">₹ <?php echo number_format($data['ven_order_info']['vendorShippingChargeAmt'],2) ?></td>
                                                </tr>
