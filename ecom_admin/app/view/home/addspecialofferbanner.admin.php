    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="addSpecialOfferBanner" enctype="multipart/form-data">
                        <?php echo $data[ 'csrf_add_spl_banner'] ?>
...
<script type="text/javascript">
    ...
    $("#addSpecialOfferBanner").validate({
        rules: {
            title: {
                required: true
            },
    ...
    function saveForm() {
        var formname = document.getElementById("addSpecialOfferBanner");
        var formData = new FormData(formname);
        $.ajax({
                url: core_path + "specialofferbanner/api/add",
                type: "POST",
                data: formData,
                contentType: false,
                cache: false,
                ...
                success: function(data) {
                    $(".page_loading").hide();
                    if (data == 1) {
                        window.location = core_path + "specialofferbanner?a=success";
                    } else {
                        $(".form-error").show();
