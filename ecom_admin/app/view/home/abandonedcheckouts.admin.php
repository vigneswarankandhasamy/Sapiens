                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Manage Customer Abandoned Checkouts</h3>
                        ...
                        <div class="card-inner">
                            <div class="card-title-group">
                                <div class="card-title">
                                    <h6 class="title"><span class="mr-2">Abandoned Checkouts list</span></h6>
                                </div>
                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-md"><span>Created  Date</span>
                                                </th>
                                                <th class="nk-tb-col"><span class="sub-text">Customer Name</span>
                                                </th>
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Cart Items</span>
                                                </th>
                                                <th class="nk-tb-col tb-col-md"><span class="sub-text">Commission Value</span>
                                                </th>
                                                <th class="nk-tb-col tb-col-md"><span class="sub-text">Cart Total</span>
                                                </th>
...
<script type="text/javascript">
    ...
    $(".open_enq_model").click(function() {
        ...
        window.location = core_path + "abandonedcheckouts/details/" + value;
    });
