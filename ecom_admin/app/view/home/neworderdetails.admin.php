                                    ...
                                    <div class="nk-block-des">
                                        <nav>
                                           <ul class="breadcrumb breadcrumb-arrow">
                                                ...
                                                <li class="breadcrumb-item"><a href="<?php echo COREPATH ?>orders/orderstab">Orders</a></li>
                                        ...
                                        <ul class="nk-block-tools g-3">
                                            ...
                                            <?php } elseif($data['v_order_info']['vendor_response']==1 && $data['v_order_info']['vendor_accept_status']==0) { ?>
                                                ...
                                                <?php if($data['check_cancel_status']==0) { ?>
                                                    <li class="nk-block-tools-opt">
                                                        <a class="btn btn-warning" href="<?php echo COREPATH ?>orders/replace/<?php echo $data['v_order_info']['id'] ?>" >
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                if(data==1) {
                    ...
                    window.location = core_path+"orders/neworderdetail/"+order_id+"?or=success";
                } else {
                    window.location = core_path+"orders/neworderdetail/"+order_id+"?ore=success";
                }
            }
            });
            return false;
