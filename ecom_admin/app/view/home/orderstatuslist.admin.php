    ...
    <div class="container-fluid wide-xl">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <!-- .nk-block-head -->
                <?php if($data['token']=="new" || $data['token']=="") { ?>
                ...
                <?php } ?>
                <?php if($data['token']=="returned" || $data['token']=="") { ?>
                <div class="nk-block nk-block-lg">
                    <div class="card card-preview">
                        <div class="card-inner">
                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                ...
                <?php } ?>
                <?php if($data['token']=="rejected" || $data['token']=="") { ?>
                <div class="nk-block nk-block-lg">
                    <div class="card card-preview">
                        <div class="card-inner">
                            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                ...
                                <tbody>
                                    <?php echo $data['list']['rejected_orders']; ?>
                                </tbody>
                            </table>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(".open_enq_model").click(function() { 
        ...
        var order_replace = $(this).data("page");

        if(order_replace=="rejected_orders") {
