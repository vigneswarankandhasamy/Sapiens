    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="editLegalPage" enctype="multipart/form-data">
                        <input type="hidden" name="session_token" id="session_token" value="<?php echo $data['token'] ?>">
                        <?php echo $data[ 'csrf_edit_legalpage'] ?>
                        <div class="form_submit_bar">
                            <div class="container wide-md">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h2><a href="javscript:void();" class="cancelSubmission" data-url="<?php echo COREPATH ?>legalpages"><i class="icon ni ni-arrow-left"></i></a>  </h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="submit_button_wrap">
                                            ...
                                            <?php endif ?>
                                            <button type="button" class="btn btn-light cancelSubmission" data-url="<?php echo COREPATH ?>legalpages"> Cancel</button>
                            ...
                            <div class="card-inner">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_name" id="title_name" value="<?php echo $data['info']['title'] ?>"  class="form-control" placeholder="Enter LegalPage Title" required>
                                    </div>
                                     <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="summernote-editor" name="description" id="description"><?php echo $data['info']['content'] ?></textarea> 
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card card-shadow">
                            <div class="card-inner">
                                <h5 class="card-title">LegalPage Image </h5>
                            ...
                            <div class="card-inner">
                                ...
                                <?php }else{ ?>
                                     <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo $data['info']['page_url'] ?>"   class="form-control" data-validation="" placeholder="Enter Page URL" disabled >
                                        <input type="hidden" name="page_url" value="<?php echo $data['info']['page_url'] ?>" >
                                    </div>
                                <?php } ?>
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $("#editLegalPage").validate({
        ...
        messages: {
            title_name: {
                required: "Please Enter LegalPage Name",
            },
            blog_category: {
                required: "Please Select LegalPage Category",
            },
            page_url: {
    ...
    function saveform() {
        var formname = document.getElementById("editLegalPage");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "legalpages/api/update",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "legalpages?e=success";
                } else {
                    //$(".form-error").show();
