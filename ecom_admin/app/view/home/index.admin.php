                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li>
                                                <div class="drodown">
                                                    <a href="#" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-calender-date"></em><span class="button_name"><span class="d-none d-md-inline button_name_ltr"> Today</em></a>
                                    ...
                                    <div class="card-inner">
                                        <div class="nk-iv-wg2">
                                            ...
                                            <div class="nk-iv-wg2-text">
                                                <div class="nk-iv-wg2-amount"> <div class="card_total_order"> <?php echo (($data['card_data'])? $data['card_data']['totalOrders']  : 0 ); ?> </div>
                                ...
                                <div class=" is-s1 card card-bordered">
                                    <div class="card-inner">
                                        <div class="nk-iv-wg2">
                                            ...
                                            <div class="nk-iv-wg2-text">
                                                <div class="nk-iv-wg2-amount"> <div class="card_total_amount">₹ <?php echo number_format( (($data['card_data'])? $data['card_data']['totalAmount']  : 0 ) ,2 ); ?></div>
                                                <span class="change up viewall_link"><a href="<?php echo COREPATH ?>orders">View All</a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class=" is-s1 card card-bordered">
                                    <div class="card-inner">
                                        <div class="nk-iv-wg2">
                                            ...
                                            <div class="nk-iv-wg2-text">
                                                <div class="nk-iv-wg2-amount"> <div class="card_avg_value">₹ <?php echo number_format((($data['card_data'])? (($data['card_data']['totalOrders'])? $data['card_data']['totalAmount']/ $data['card_data']['totalOrders'] : 0) : 0 ),2); ?></div>
                                                <span class="change up viewall_link"><a href="<?php echo COREPATH ?>orders">View All</a> 
                                                </div>
                                            </div>
                                        </div>
    ...
    $(".get_Chart_data").click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $(".card_order_notseen").html(obj.card_total_not_seen_order);
