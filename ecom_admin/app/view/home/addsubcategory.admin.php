    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="addSubcategory" enctype="multipart/form-data">
                        <?php echo $data[ 'csrf_add_subcategory'] ?>
                                ...
                                <h5 class="card-title">Vendor</h5>
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="vendor_commission" id="vendor_commission" class="form-control" placeholder="Zupply Commission" >
                                        </div>
                                        <div class="form-group col-md-6">
...
<script type="text/javascript">
    ...
    $("#addSubcategory").validate({
        ...
        messages: {
            title_name: {
                required: "Please Enter Subcategory Title",
            },
            category_category: {
                required: "Required",
            },
    ...
    function saveForm() {
        var formname = document.getElementById("addSubcategory");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "subcategory/api/add",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                ...
                console.log(data);
                if (data == 1) {
                    window.location = core_path + "subcategory?a=success";
                } else {
                    $(".form-error").show();
