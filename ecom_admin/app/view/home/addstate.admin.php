    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="addBrand" enctype="multipart/form-data">
                        <?php echo $data[ 'csrf_add_brand'] ?>
                            ...
                            <div class="card-inner">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_name" id="title_name" class="form-control" placeholder="Enter Brand Name" required>
                                    </div>
                                    <div class="form-group col-md-6">
...
<script type="text/javascript">
    ...
    function saveForm() {
        var formname = document.getElementById("addBrand");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "brand/api/add",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "brand?a=success";
                } else {
                    $(".form-error").show();
