        ...
        <div class="container-fluid wide-md">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                        <form method="post"  class="form-validate is-alter" id="editUser">
                            <?php echo $data['csrf_edit_user'] ?>
                            ...
                            <div class="form_submit_bar">
                                <div class="container wide-md">
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-md-6">
                                            <p> 
                                                <label class="form-label"> <input type="checkbox" name="save_as_draft" value="1" <?php echo (($data['info']['is_draft']==1)? 'checked' : '') ?>>  Save as Draft </label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mobile" id="mobile" value="<?php echo($data['info']['mobile']) ?>" class="form-control" autocomplete="off" placeholder="Enter Mobile Number" >
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-control" required="" name="status">
                                                       <option value="1"  <?php echo(($data['info']['status']=="1")? 'Selected' : '' )?> >Active </option>
                                                        <option value="0" <?php echo(($data['info']['status']=="0")? 'Selected' : '' )?> >Inactive</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div> -->
                            ...
                            <div class="card card-shadow">
                                <div class="card-inner">
                                    <h5 class="card-title">Permoission Info</h5>
...
<script type="text/javascript">
    ...
    $("#editUser").validate({
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                type: "POST",
                url: core_path + "users/api/update",
                dataType: "html",
                data: content,
                beforeSend: function() {
                    $(".page_loading").show();
                ...
                success: function(data) {
                    $(".page_loading").hide();
                    if (data == 1) {
                        window.location = core_path + "users?ue=success";
                    } else {
                        $(".form-error").show();
