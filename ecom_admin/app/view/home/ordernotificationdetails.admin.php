                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <?php if($data['v_order_info']['return_status']!=1 && $data['v_order_info']['vendor_response']!=1) { ?>
                                            <li class="nk-block-tools-opt"><button class="btn btn-primary" data-toggle="modal" data-target="#modalForm"><em class="icon ni ni-list-check"></em><span> order Response</span></button> 
                                            </li>
                                            <?php } elseif($data['v_order_info']['vendor_response']==1 && $data['v_order_info']['vendor_accept_status']==0) { ?>
                                            <li class="nk-block-tools-opt"><a class="btn btn-warning" href="<?php echo COREPATH ?>orders/replace/<?php echo $data['v_order_info']['id'] ?>" ><em class="icon ni ni-external"></em><span> Replace Order</span></a> 
                                            </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                    ...
                                    <ul class="data-list is-compact">
                                        ...
                                        <li class="data-item">
                                            <div class="data-col">
                                                ...
                                                <div class="data-value"><?php echo (($data['v_order_info']['vendor_response']==0)? "Not Seen" : (($data['v_order_info']['vendor_accept_status']==1)? "Accepted" : "Rejected")); ?></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div><!-- .card -->
...
<script type="text/javascript">
     ...
     $("#orderResponseStatus").validate({ 
        ...
        submitHandler: function(form) {
            ...
            toastr.clear();
            var order_id = "<?php echo $data['v_order_info']['id'] ?>";
            ...
            $.ajax({
                ...
                if(data==1) {
                    ...
                    window.location = core_path+"orders/notificationdetail/"+order_id+"?or=success";
                } else {
                    window.location = core_path+"orders/notificationdetail/"+order_id+"?ore=success";
                }
            }
            });
            return false;
