                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content">
                                <a href="<?php echo COREPATH ?>subcategory/add" class="btn btn-primary" ><em class="icon ni ni-plus"></em> Add Subcategory </a>
                            </div><!-- .nk-block-head-content -->
...
<script type="text/javascript">
    ...
    // Active & Inactive Status For Subcategory
    ...
    $(".changeSubcategoryStatus").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: core_path + "subcategory/api/status",
            dataType: "html",
            data: { result: value },
            beforeSend: function() {
                $(".page_loading").show();
    ...
    $(".trashSubcategory").click(function(e) {
        toastr.clear();
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "subcategory/api/trash",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "subcategory?t=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'bottom-center', 
    ...
    $(".deleteSubcategory").click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "subcategory/api/delete",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "subcategory?d=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'bottom-center', 
    ...
    // Published Subcategory item

    $(".publishSubcategory").click(function(e) {
        toastr.clear();
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "subcategory/api/publish",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "subcategory?p=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'bottom-center', 
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Subcategory  added successfully !!</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Subcategory  Updated successfully !!</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Subcategory  Deleted successfully !!</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Subcategory moved to trash successfully !!</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Subcategory published successfully !!</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
