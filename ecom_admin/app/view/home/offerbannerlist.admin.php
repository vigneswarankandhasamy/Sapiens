                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content">
                                <?php if($data['count']==0) { ?>
                                <a href="<?php echo COREPATH ?>offerbanner/add" class="btn btn-primary" ><em class="icon ni ni-plus"></em> Add Offer Banner </a>
                                <?php } ?>
                            </div><!-- .nk-block-head-content -->
...
<script type="text/javascript">
    ...
    $(".changeOfferBannerStatus").click(function() {
        toastr.clear();
        var value = $(this).data("option");
        $.ajax({
            type: "POST",
            url: core_path + "offerbanner/api/status",
            dataType: "html",
            data: { result: value },
            beforeSend: function() {
                $(".page_loading").show();
    ...
    // Delete Offer Banner item

    $(".trashOfferBanner").click(function(e) {
        toastr.clear();
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "offerbanner/api/trash",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "offerbanner?t=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'top-right', 
    ...
    $(".deleteOfferBanner").click(function(e) {
        toastr.clear();
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "offerbanner/api/delete",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "offerbanner?d=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'top-right', 
     ...
     // Published OfferBanner item

    $(".publishOfferBanner").click(function(e) {
        toastr.clear();
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "offerbanner/api/publish",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "offerbanner?p=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'top-right', 
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Offer Banner added successfully !!</h5>', 'success', {
        position: 'top-right', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Offer Banner updated successfully !!</h5>', 'success', {
        position: 'top-right', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Offer Banner deleted successfully !!</h5>', 'success', {
        position: 'top-right', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Offer Banner published successfully !!</h5>', 'success', {
        position: 'top-right', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
