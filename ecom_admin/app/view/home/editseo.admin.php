    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="editSeoContent" enctype="multipart/form-data">
                        <input type="hidden" name="session_token" id="session_token" value="<?php echo $data['token'] ?>">
                        <?php echo $data[ 'csrf_edit_seo'] ?>
                        <div class="form_submit_bar">
                            <div class="container wide-md">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h2><a href="javscript:void();" class="cancelSubmission" data-url="<?php echo COREPATH ?>seo"><i class="icon ni ni-arrow-left"></i></a>  </h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="submit_button_wrap">
                                            ...
                                            <?php endif ?>
                                            <button type="button" class="btn btn-light cancelSubmission" data-url="<?php echo COREPATH ?>seo"> Cancel</button>
                            ...
                            <div class="card-inner">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_name" id="title_name" value="<?php echo $data['info']['page_title'] ?>"  class="form-control" placeholder="Enter SeoContent Title" required>
                                    </div>
                                     <div class="form-group col-md-6">
                                        <label class="form-label">Page Token
                                            <em>*</em>
                                        </label>
                                        <input type="text" name="page_token" id="page_token" value="<?php echo $data['info']['page_token'] ?>" class="form-control" placeholder="Enter Page Token" required>
                                    </div>
                                    <?php if(1 != 1) { ?>
                                    <!-- <div class="form-group col-md-12">
                                        <label class="form-label" >Content <em>*</em>
                                        </label>
                        ...
                        <div class="card card-shadow">
                            <div class="card-inner">
                                <h5 class="card-title">Seo Image </h5>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <p class="help_text"><?php echo SEO_IMAGE_HELP_TEXT ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
...
<script type="text/javascript">
    ...
    $("#editSeoContent").validate({
       rules: {
        ...
        messages: {
            title_name: {
                required: "Please Enter Seo Content Title",
            },
            page_token: {
    ...
    function saveform() {
        var formname = document.getElementById("editSeoContent");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "seo/api/update",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "seo?e=success";
                } else {
                    //$(".form-error").show();
