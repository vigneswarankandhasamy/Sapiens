    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="editPageBanner" enctype="multipart/form-data">
                        <input type="hidden" name="session_token" id="session_token" value="<?php echo $data['token'] ?>">
                        <?php echo $data[ 'csrf_edit_page_banner'] ?>
                            ...
                            <div class="card-inner">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="page_name" id="page_name"  class="form-control" value="<?php echo $data['info']['page_name'] ?>" placeholder="Enter Page Name" required>
                                    </div>
                        ...
                        <div class="card card-shadow">
                            <div class="card-inner">
                                <h5 class="card-title">Page Banners Image </h5>
...
<script type="text/javascript">
    ...
    function saveform() {
        var formname = document.getElementById("editPageBanner");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "pagebanner/api/update",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "pagebanner?e=success";
                } else {
                    $(".form-error").show();
