                            ...
                            <div class="card-inner">
                                ...
                                <?php if ($data['info']['is_draft']==1){ ?>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="page_url" id="page_url" value="<?php echo $data['info']['token'] ?>"  required="" class="form-control" data-validation="" placeholder="Enter Page URL" >
                                    </div>
                                <?php }else{ ?>
                                     <div class="form-group">
                                        <label class="form-label" >Page URL <em>*</em>
                                        </label>
                                        <input type="text" value="<?php echo $data['info']['token'] ?>"  required="" class="form-control" data-validation="" placeholder="Enter Page URL" disabled >
                                    </div>
                                <?php } ?>
                                <div class="form-group">
