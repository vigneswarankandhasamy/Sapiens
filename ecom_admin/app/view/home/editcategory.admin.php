    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="editCategory" enctype="multipart/form-data">
                        <input type="hidden" name="session_token" id="session_token" value="<?php echo $data['token'] ?>">
                        <?php echo $data[ 'csrf_edit_category'] ?>
                             ...
                             <div class="card-inner">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_name" id="title_name"  value="<?php echo $data['info']['category'] ?>" class="form-control" placeholder="Enter Category Name" required>
                                    </div>
                                    <div class="form-group col-md-6">
...
<script type="text/javascript">
    ...
    function saveform() {
        var formname = document.getElementById("editCategory");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "category/api/update",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "category?e=success";
                } else {
                    //$(".form-error").show();
