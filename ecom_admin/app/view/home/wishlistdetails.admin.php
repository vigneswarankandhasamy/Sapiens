                                    ...
                                    <ul class="data-list is-compact">
                                        <li class="data-item">
                                            <div class="data-col">
                                                ...
                                                <div class="data-value"><?php echo $data['customer_info']['name']; ?></div>
                                            </div>
                                        </li>
                                        <li class="data-item">
                                            <div class="data-col">
                                                <div class="data-label">Mobile Number</div>
                                                <div class="data-value"><?php echo $data['customer_info']['mobile']; ?></div>
                                            </div>
                                        </li>
                                        <li class="data-item">
                                            <div class="data-col">
                                                <div class="data-label">Email</div>
                                                <div class="data-value"><?php echo $data['customer_info']['email']; ?></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
