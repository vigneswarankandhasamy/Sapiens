                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content">
                                <a href="<?php echo COREPATH ?>users/add" class="btn btn-primary"> <em class="icon ni ni-plus"></em> Add New User  </a>
                            </div><!-- .nk-block-head-content -->
                                ...
                                <table class="datatable-init nk-tb-list nk-tb-ulist is-compact" data-auto-responsive="false">
                                    <thead>
                                        <tr class="nk-tb-item nk-tb-head">
                                            ...
                                            <th class="nk-tb-col tb-col-md"><span class="sub-text">Invite</span></th>
...
<script type="text/javascript">
    ...
    $(".changeUserStatus").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: core_path + "users/api/status",
            dataType: "html",
            data: { result: value },
            beforeSend: function() {
                $(".page_loading").show();
    ...
    $(".trashUser").click(function(e) {
        toastr.clear();
        Swal.fire({
            title: "Are you sure to move this user to trash?",
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "users?t=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'top-right', 
    ...
    $(".deleteUser").click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "users/api/delete",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "users?d=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'top-right', 
    ...
    $(".publishUser").click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "users/api/publish",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + "users?p=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'top-right', 
    ...
    $(".sendInvite").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: core_path + "users/api/sendInvite",
            dataType: "html",
            data: { result: id },
            beforeSend: function() {
                $(".page_loading").show();
...
<?php if (isset($_GET['a'])): ?>
    ...
    setTimeout(function() {
        toastr.clear();
        NioApp.Toast('<h5>User added successfully !!</h5>', 'success', {
            position: 'top-right', 
            ui: 'is-light',
            "progressBar": true,
            "showDuration": "300",
...
<?php if (isset($_GET['e'])): ?>
    ...
    setTimeout(function() {
        toastr.clear();
        NioApp.Toast('<h5>User updated successfully !!</h5>', 'success', {
            position: 'top-right', 
            ui: 'is-light',
            "progressBar": true,
            "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>User moved to trash successfully !!</h5>', 'success', {
        position: 'top-right', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>User published successfully !!</h5>', 'success', {
        position: 'top-right', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
