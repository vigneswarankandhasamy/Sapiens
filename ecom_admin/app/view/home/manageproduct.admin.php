                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content">
                                <?php if($data['future_product']==0) { ?>
                                <a href="<?php echo COREPATH ?>products/add" class="btn btn-primary" ><em class="icon ni ni-plus"></em> Add Product </a>
                                <?php }else { ?>
                                <a href="<?php echo COREPATH ?>products/addfuture" class="btn btn-primary" ><em class="icon ni ni-plus"></em> Add Future Product </a>
                                <?php } ?>
                            </div><!-- .nk-block-head-content -->
...
<script type="text/javascript">
    ...
    $(".changeProductStatus").click(function() {
        ...
        $.ajax({
            type: "POST",
            url: core_path + "products/api/status",
            dataType: "html",
            data: { result: value },
            beforeSend: function() {
                $(".page_loading").show();
    ...
    $(".trashProduct").click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "products/api/trash",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
    ...
    $(".deleteProduct").click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "products/api/delete",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path + link  +  "?d=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'bottom-center', 
    ...
    $(".publishProduct").click(function(e) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type: "POST",
                    url: core_path + "products/api/publish",
                    dataType: "html",
                    data: { result: value },
                    beforeSend: function() {
                        $(".page_loading").show();
                    ...
                    success: function(data) {
                        ...
                        if (data == 1) {
                            //alert(data);
                            window.location = core_path +  link +"?p=success";
                        } else {
                            toastr.clear();
                            NioApp.Toast('<h5>'+data+'</h5>', 'error', {
                                position: 'bottom-center', 
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Product  added successfully !</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Product  Deleted successfully !</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Product moved to trash successfully !</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
...
setTimeout(function() {
    toastr.clear();
    NioApp.Toast('<h5>Product published successfully !</h5>', 'success', {
        position: 'bottom-center', 
        ui: 'is-light',
        "progressBar": true,
        "showDuration": "300",
