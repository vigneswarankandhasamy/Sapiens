                        ...
                        <div class="card-inner">
                            <div class="card-title-group">
                                <div class="card-title">
                                    <h6 class="title"><span class="mr-2">Vendor Rejected Order List</span></h6>
                                </div>
                            ...
                            <div class="card card-shadow">
                                ...
                                <thead>
                                    <tr class="nk-tb-item nk-tb-head">
                                        ...
                                        <th class="nk-tb-col tb-col-md"><span class="sub-text">Response Message</span>
                                        </th>
...
<script type="text/javascript">
    ...
    $(".export_order_list").click(function() { 
        ...
        if(from=="") {
            var text_msg = "Are you sure to export overall vendor rejected order list ?";
            html_string = $.parseHTML( text_msg );
        } else {
            var text_msg = "Are you sure to export <br> vendor rejected order list from <br> " + from + " to " + to +" ?";
            html_string = $.parseHTML( text_msg );
        }
         ...
         Swal.fire({
                ...
                if (result.value) {
                   if(from!="") {
                        ...
                        window.location = core_path + "exportData/vendorrejectedorders" + "/" + formatted_from_date + "/" + formatted_to_date ;
                    } else {
                        window.location = core_path + "exportData/vendorrejectedorders"+ "/overall";
                    } 
                }
            });
    });
