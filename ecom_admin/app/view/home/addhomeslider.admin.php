    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="addHomeSlider" enctype="multipart/form-data">
...
<script type="text/javascript">
    ...
    function saveForm() {
        var formname = document.getElementById("addHomeSlider");
        var formData = new FormData(formname);
        $.ajax({
                url: core_path + "homeslider/api/add",
                type: "POST",
                data: formData,
                contentType: false,
                cache: false,
                ...
                success: function(data) {
                    $(".page_loading").hide();
                    if (data == 1) {
                        window.location = core_path + "homeslider?a=success";
                    } else {
                        $(".form-error").show();
