    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="editSubcategory" enctype="multipart/form-data">
                        <input type="hidden" name="session_token" id="session_token" value="<?php echo $data['token'] ?>">
                        <?php echo $data[ 'csrf_edit_subcategory'] ?>
                        <div class="form_submit_bar">
                            <div class="container wide-md">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h2><a href="javscript:void();" class="cancelSubmission" data-url="<?php echo COREPATH ?>subcategory"><i class="icon ni ni-arrow-left"></i></a>  </h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="submit_button_wrap">
                                            ...
                                            <?php endif ?>
                                            <button type="button" class="btn btn-light cancelSubmission" data-url="<?php echo COREPATH ?>subcategory"> Cancel</button>
                             ...
                             <div class="card-inner">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="title_name" id="title_name"  value="<?php echo $data['info']['subcategory'] ?>" class="form-control" placeholder="Enter Subcategory Name" required>
                                    </div>
                                    ...
                                    <div class="form-group col-md-3 select_item_wrap">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="form-control form-control-lg add_main_category" data-search="on" name="category_id" required>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <p class="help_text"><?php echo SUB_CATEGORY_IMAGE_HELP_TEST ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
...
<script type="text/javascript">
    ...
    function saveform() {
        var formname = document.getElementById("editSubcategory");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "subcategory/api/update",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "subcategory?e=success";
                } else {
                    //$(".form-error").show();
