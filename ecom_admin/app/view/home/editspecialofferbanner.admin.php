    ...
    <div class="container-fluid wide-md">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="editSpecialOfferBanner" enctype="multipart/form-data">
                        <input type="hidden" name="session_token" id="session_token" value="<?php echo $data['token'] ?>">
                        <?php echo $data[ 'csrf_edit_spl_banner'] ?>
                        <div class="form_submit_bar">
                            <div class="container wide-md">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h2><a href="javscript:void();" class="cancelSubmission" data-url="<?php echo COREPATH ?>specialofferbanner"><i class="icon ni ni-arrow-left"></i></a>  </h2>
                                    ...
                                    <div class="col-md-6">
                                        <div class="submit_button_wrap">
                                            ...
                                            <?php endif ?>
                                            <button type="button" class="btn btn-light cancelSubmission" data-url="<?php echo COREPATH ?>specialofferbanner"> Cancel</button>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <p class="help_text"><?php echo SPECIAL_OFFER_BANNER_IMAGE_HELP_TEXT ?></p>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
...
<script type="text/javascript">
    ...
    $("#editSpecialOfferBanner").validate({
        rules: {
            title: {
                required: true
            },
    ...
    function saveform() {
        var formname = document.getElementById("editSpecialOfferBanner");
        var formData = new FormData(formname);
        $.ajax({
            url: core_path + "specialofferbanner/api/update",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "specialofferbanner?e=success";
                } else {
                    $(".form-error").show();
