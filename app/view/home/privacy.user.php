...
<div class="privacy-banner otherpage-banner m-0">
    <img src="<?php echo IMGPATH ?>privacy-banner.jpg" alt="">
    <div class="other-banner-title">
        <p>Privacy Policy</p>
        <button type="button" class="btn btn-sm banner-btn rounded-pill"><a href="<?php echo BASEPATH ?>privacy">View more</a></button>
    </div>   
</div>  
			...
			<div class="col-12">
				<div class="breadcrumb_content">
					<ul>
						...
						<li><a href="<?php echo BASEPATH ?>privacy">Privacy Policy</a></li>
					</ul>
				</div>
			</div>
		</div> 
...
<div class="container-fluid">
	...
	<h5>Nature Of Information Collected And Manner Of Collection :</h5>
	...
	<h5>Amendments to the Privacy Policy:</h5>
	...
	<h5>Terms of Use:</h5>
	<p>This Privacy policy shall form a part of the Terms of Use Third party vendors, including Google, use cookies to serve ads based on a user's prior visits to your website.</p>
