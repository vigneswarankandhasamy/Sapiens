...
<div class="terms-banner otherpage-banner m-0">
    <img src="<?php echo IMGPATH ?>terms-banner.jpg" alt="">
    <div class="other-banner-title">
        <p>Terms of Use</p>
        <button type="button" class="btn btn-sm banner-btn rounded-pill"><a href="<?php echo BASEPATH ?>terms">View more</a></button>
    </div>   
</div>  
			...
			<div class="col-12">
				<div class="breadcrumb_content">
					<ul>
						...
						<li><a href="<?php echo BASEPATH ?>terms">Terms of Use</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<section class="ls ms s-pt-xl-200 s-pt-lg-230 s-pt-md-190 s-pt-160 s-pb-xl-100 s-pb-lg-200 s-pb-md-160 s-pb-130 c-mb-30">
	...
	$mailid = "Sapiens@gmail.com";
	$country = "India";
	?>
	<div class="container-fluid">
		<div class="row mytermprivacy">
			<div class="col-md-12 col-xl-12 text-sm-left p-45 ls rounded mb-5 mt-4">
				<h2 class="special-heading text-center text-sm-left">
					<span class="text-capitalize">
						<span class="thin">Terms of use</span> 
					</span>
				</h2>
				<div class="divider-wave bg-gradient text-center text-sm-left"></div>
				<div class="divider-25"></div>
				<h5 class="terms_title"><?php echo $sitename; ?> Website Terms of Use</h5>
		...
		<p>Upon completion of the beta stage, any further use of the newly created Website shall be based on the acceptance of the Terms of Use of the final Website released by the Company.</p>
		<ul>
			<li><strong> Acceptance of Terms of Use :</strong></li>
			<li>By accessing and using the Website you agree and acknowledge that the Company has made this Website available to you without any consideration as it is a beta Website. You further acknowledge that this is a test Website and may not function fully as it otherwise would in its final form and may contain errors. All risk that arises from the use of this Website shall be borne by you, including risks related to loss of data or damage to your computer system.</li>
			<li class="mt-3"><strong> Website Access and Terms of Use</strong>
		<ol type="a">
			...
			<li>You agree that you will use the Website only in relation to seeking services or goods <?php echo $country;?>, and shall not share information from the Website with any third party who is not a permitted user of the beta Website.</li>
			...
			<li class="mt-3"><strong> Permitted Uses</strong>
		<ol type="a">
			...
			<li class="mt-3"><strong> Prohibited Use,</strong> In relation to the use and access of the Website its content and features, you agree and undertake not to:
		...
		<ol type="a">
			...
			<li class="mt-3"><strong> Privacy and Personally Identifiable Data :</strong> </li>
			<li>The information collected by the Company on the Website shall be governed by these Terms and the Privacy Policy. All information collected shall be available to you to modify as required. Sensitive personal information shall be treated in accordance to applicable Indian laws. Access to the same shall be provided to third parties who have access rights under an agreement with the Company under similar terms. All User Information will be used and processed in accordance with these Terms and the Privacy Policy, you agree that you have read and understood the Privacy Policy.</li>
			<li class="mt-3"><strong> Intellectual Property,</strong> You agree and understand that :
		...
		<ol type="a">
			...
			<li class="mt-3"><strong> Limitation of Liability :</strong> </li>
			<li>The aggregate liability of the Company to you, whether in contract, tort, negligence or otherwise, howsoever arising, whether in connection with these Terms, or your access and use of this Website and its contents and functionalities or for any reason related to the operation of the Website, shall not exceed Rupees hundred (100). In no event shall the Company be liable for any loss of profits (anticipated or real), loss of business, loss of reputation, loss of data, loss of goodwill, loss of employment, any business interruption or any direct, indirect, special, incidental, consequential, punitive, tort or other damages, however caused, whether or not it has been advised of the possibility of such damages.</li>
			<li class="mt-3"><strong>Indemnity :</strong> </li>
			<li>You agree to indemnify and hold harmless, the Company, its employees and agents, against any claims, losses, damages or costs arising from their</li>
		<ol type="i">
		...
		<ol type="i">
			...
			<li class="mt-3"><strong> Complaints :</strong> </li>
			<li>Should you have any complaints regarding the Website, including but not limited to abuse and misuse of the Website, copyright infringement and the like, or any issues related to data privacy please report the same to: <a title="Mail US" href="mailto:<?php echo $mailid; ?>"><?php echo $mailid; ?></a></li>
		<li>Please provide your name, email address, physical address and contact numbers so that the Company may be in a position to verify details or check the authenticity of the complaints.</li>
			<li class="mt-3"><strong> Links to third Party Sites :</strong> </li>
			<li>You shall not create a link to a page of this website without our prior permission. If you do so, such creation shall be at your risk and the Company shall only be liable to the extent set forth in these Terms.</li>
			<li class="mt-3"><strong> Miscellaneous Provisions</strong></li>
		<ol type="a">
			...
			<li>Governing Law : These Terms are governed by the laws of the Republic of India. The courts at Coimbatore, India shall have exclusive jurisdiction over any claims or matters arising out of these Terms or in relation to any matter related to the Website.</li>
		</ol>
		</li>
		</ul>
			</div>
