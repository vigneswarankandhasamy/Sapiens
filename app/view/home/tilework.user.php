            ...
            <div class="col-12">
                <div class="breadcrumb_content">
                    <ul>
                        ...
                        <li><a href="<?php echo BASEPATH ?>calculator/floring" class="breadcrumb_active">Flooring</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="card list_wrap">
                    ...
                    <div class="row">
                        <div class="col-md-7 col-xs-12 col-sm-12">
                            <form id="tileWorkCalculation" method="POST" action="#">
                                <div class="row mb-3">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    <div class="input-group-area"> 
                                                        <input type="number" class="form-control"  onKeyPress="if(this.value.length==6) return false;" name="lengthMeterOrFeet" min="0"  id="lengthMeterOrFeet" placeholder="meter">
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    <div class="input-group-area"> 
                                                        <input type="number" class="form-control"  onKeyPress="if(this.value.length==3) return false;" name="lengthCmOrInch" min="0"  id="lengthCmOrInch" placeholder="cm">
                                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                             <div class="col-lg-6">
                                                <div class="input-group">
                                                    <div class="input-group-area"> 
                                                        <input type="number" class="form-control"  onKeyPress="if(this.value.length==6) return false;" name="widthMeterOrFeet" min="0"  id="widthMeterOrFeet" placeholder="meter">
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-group">
                                                    <div class="input-group-area"> 
                                                        <input type="number" class="form-control"  onKeyPress="if(this.value.length==3) return false;" name="widthCmOrInch" min="0"  id="widthCmOrInch" placeholder="cm">
                                                    </div>
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-form-label">Tile Dimension</label>
                                    <div class="col-6">
                                        <label for="inputEmail3" class="col-form-label">Length</label>
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-group">
                                                    <div class="input-group-area"> 
                                                        <input type="text" class="form-control" min="0"  name="tileLength" id="tileLength" placeholder="feet">
                                                    </div>
                                                    <div class="input-group-icon tileLength">feet</div>
                                                </div>
                                                <div id="tileLengthError">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="input-group">
                                                    <div class="input-group-area"> 
                                                        <input type="text" class="form-control" min="0"  name="tileWidth" id="tileWidth" placeholder="feet">
                                                    </div>
                                                    <div class="input-group-icon tileWidth">feet</div>
                                                </div>
                                                <div id="tileWidthError">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <table id='tableData' class='tableData'></table><br>
                                            <div class="chart" style="width: 65%">
                                                <canvas class="d-block" id="calctiles"></canvas>
                                            </div>
   ...
   $("#tileWorkCalculation").validate({
    ...
    messages: {
        ...
        lengthCmOrInch: {
         ...
         tileLength: {
            required: "Tile length cannot be empty",
            digits: "Enter only numeric values decimal values are not allowed for this calculation",
        },
         tileWidth: {
            required: "Tile width cannot be empty",
            digits: "Enter only numeric values decimal values are not allowed for this calculation",
        },
    ...
    errorPlacement : function (error, element) {
        ...
        } else if(element.attr("name") == "tileLength") {
            error.appendTo("#tileLengthError");
        } else if(element.attr("name") == "tileWidth") {
            error.appendTo("#tileWidthError");
        } 
    },
    ...
    submitHandler: function (form) {
        ...
        $.ajax({
            type: "POST",
            url: base_path + "calculator/api/tileWorkCalculation",
            dataType: "html",
            data: content,
            beforeSend: function () {
                $(".page_loading").show();
            ...
            success: function (data) {
                ...
                tileworkCalculationChart(json["tile"],json["cement"],json["sand"],json["sand_cft"])
            }
        });
        return false;
    } 
    ...
    function tileworkCalculationChart(tile,cement,sand,sand_cft) {
        var options = {
            // legend: false,
            responsive: true
        };

        $('#tableData').html( '<tr><th>' + 'Tiles' + '</th><td>' + tile + ' Tiles'+ '</td></tr><tr><th>' + 'Cement' + '</th><td>' + cement + ' Bags'+ '</td></tr><tr><th>' + 'Sand' + '</th><td>' + sand + ' Tons'+ ' (' + sand_cft + 'CFT)</td></tr>' );
        
        let init = function() {
            chart_obj = new Chart($("#calctiles"), {
                type: 'doughnut',
