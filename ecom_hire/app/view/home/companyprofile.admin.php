            ...
            <div class="nk-content-body">
                ...
                <div class="nk-block">
                    <form method="post" class="form-validate is-alter" id="editVendor" >
                        ...
                        <?php echo $data['csrf_edit_company'] ?>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="form-control-wrap">
                                                ...
                                                <p class="help_text"><?php echo HIRE_PROFILE_IMAGE_HELP_TEXT ?></p>
                                            </div>
                                        </div>
                                ...
                                <?php }else{ ?>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <div class="form-control-wrap">
                                                <img src="<?php echo SRCIMG.$data['info']['file_name'] ?>" class="img-thumbnail img-responsive" >
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="row">
                         ...
                         <div class="card card-shadow">
                            <div class="card-inner">
                                ...
                                <div class="form-group col-md-6">
                                       ...
                                       <!--  <input type="text" name="total_projects" value="<?php echo $data['project']['id'] ?>" id="total_projects" class="form-control" autocomplete="off" placeholder="Enter Total Projects"> -->
...
<script type="text/javascript">
    ...
    function saveform() {
        ...
        $.ajax({
            url: core_path + "profile/api/updateCompany",
            type: "POST",
            data: formData,
            contentType: false,
            cache: false,
            ...
            success: function(data) {
                $(".page_loading").hide();
                if (data == 1) {
                    window.location = core_path + "?e=success";
                } else {
                    //$(".form-error").show();
